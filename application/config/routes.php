...
$route['all_service_request'] = 'Administrator/sales/allServiceRequest';
$route['service_approved_list'] = 'Administrator/sales/serviceApprovedList';
$route['get_product_service_record'] = 'Administrator/sales/getProductServiceRecord';
// branch wise showing service request
$route['get_transfared_service_list'] = 'Administrator/sales/getTransfaredServiceList';
$route['get_product_service_record_edit'] = 'Administrator/sales/getProductServiceRecordUpdate';  
$route['update_pending_service'] = 'Administrator/sales/updatePendingService';
//main branch to another branch service transfer
$route['transfared_service'] = 'Administrator/sales/transfaredService';      
