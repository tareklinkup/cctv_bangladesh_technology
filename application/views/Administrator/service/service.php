                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" v-model="service.invoice" required
                                        @change="getServices" />
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6">
                            <form @submit.prevent="addToCart">
                                ...
                                <!-- <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" v-model="product.imei"
                                            @change="checkImeiNo" required>
                                    </div>
                                </div> -->
                                <div class="form-group">
                                    <label class="col-sm-4 control-label no-padding-right">Rep. Status </label>
                                    <div class="col-sm-8">
                                        <select class="form-control" style="height: 30px;border-radius:3px"
                                ...
                                <div class="form-group" style="display:none ;"
                                    :style="{display: product.status == 't' || product.status == 'r' ? '' : 'none'}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <button type="submit"
                                            class="btn btn-default btn-sm pull-right">{{ cartProductEditIndex == null ? 'Add': 'Update'}}</button>
                                    </div>
                                </div>
                            </form>
                    ...
                    <tbody style="display:none;" v-bind:style="{display: cart.length > 0 ? '' : 'none'}">
                        <tr v-for="(product, sl) in cart">
                            ...
                            <td>
                                ...
                                <a href="" v-on:click.prevent="editCartItem(sl)" v-if="service.serviceId != 0"><i
                        ...
                        <tr>
                            <td colspan="3"><textarea style="width: 100%;font-size:13px;" placeholder="Note"
                                    v-model="service.note"></textarea></td>
                            ...
                            <td colspan="2" style="padding-top: 15px;font-size:18px;">
                                {{ cart.reduce((p, c) => {return +p + +c.quantity}, 0 ) }}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
                        ...
                        <div class="col-sm-12">
                            <form @submit.prevent="addToCosting">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-1">
                                        <a href="<?= base_url('expense')?>" class="btn btn-xs btn-danger"
                                            style="height: 25px; border: 0; width: 27px; margin-left: -17px;"
                                            target="_blank" title="Add New Expense"><i class="fa fa-plus"
                                                aria-hidden="true" style="margin-top: 5px;"></i></a>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" v-model="cost.rate"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" v-model="cost.unit"
                                            @input="calculateTotal" required>
                                    </div>
                                </div>
                                <div class="form-group">
                ...
                <table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
                    ...
                    <tbody style="display:none;" v-bind:style="{display: costCart.length > 0 ? '' : 'none'}">
                        <tr v-for="(product, sl) in costCart">
                            ...
                            <td><a href="" v-on:click.prevent="removeFromCostCart(sl)"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td colspan="2" style="font-size:18px;">
                                {{ costCart.reduce((p, c) => {return +p + +c.amount}, 0 ) }}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            <button class="btn btn-sm pull-right" @click.prevent="saveService"
                v-bind:disabled="serviceOnProgress ? true : false">Save</button>
        </div>
    </div>
</div>
...
new Vue({
    ...
    methods: {
        ...
        addToCart() {
            if ((this.serials.length > 0 && this.serial == '')) {
            ...
            let product = {
                ...
                imei: this.serial.ps_serial_number,
            ...
            if (this.cartProductEditIndex != null) {
                ...
                let checkIfExist = this.cart.findIndex(p => (p.imei == this.serial.ps_serial_number) && (p
                    .imei != editProduct
                    .imei));
                ...
                let checkProduct = this.cart.findIndex(item => item.Product_Name == this.selectedProduct
                    .product_name &&
                    item.serial == this.serial.ps_serial_number);
                if (checkProduct > -1) {
            ...
            axios.post('/get_service', {
                ...
                .then(res => {
                    ...
                    this.selectedCustomer = {
                        ...
                        display_name: service.Customer_Type == 'G' ? 'General Customer' :
                            `${service.Customer_Code} - ${service.Customer_Name}`,
