                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12" style="display: flex; margin-bottom: 5px;">
                                            <input type="text" autocomplete="off" ref="serialnumberadd"
                                                id="serial_number" name="serial_number" v-model="get_serial_number"
                                                class="form-control" placeholder="Please Enter Serial Number"
                                                style="height: 30px;" />

                                            <input type="submit" class="btn btn-sm primary"
                                                style="border: none; font-size: 13px; line-height: 0.38; margin-left: -1px; background-color: #42b983 !important;height: 29px; margin-left: 2px;"
                                                value="Add">
                            ...
                            <table class="table" style="margin-top: 15px;">
                                ...
                                <tbody>
                                    ...
                                    <tr v-for="(product, sl) in serial_cart">
                                        ...
                                        <td>{{product.name}}</td>
                                        <td @click="remove_serial_item(product.serialNumber)"> <span
                            ...
                            <form v-on:submit.prevent="addToCart">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-4" style="display: flex;">
                                        <input type="text" step="0.01" id="quantity" autocomplete="off" name="quantity"
                                        ...
                                        <button type="button" id="show-modal" @click="serialShowModal"
                                            style="background: rgb(195 36 36 / 83%); color: white; border: none; font-size: 15px; height: 24px;width:36px; margin-left: 1px;margin-right:2px"><i
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4 control-label no-padding-right"> Warranty
                                        <small>(Month)</small> </label>
                                    <div class="col-sm-8">
                                        <input type="number" v-model.number="selectedProduct.warranty_month" min="0"
                                            class="form-control" />
                                    </div>
                                </div>
                        ...
                        <tr v-for="(product, sl) in cart">
                            ...
                            <td>{{ product.name }} <br>
                                (<span v-for="(SerialCartStore, ind) in product.SerialCartStore ">
                                    {{ SerialCartStore.serialNumber }}<span v-if="product.SerialCartStore.length > 1">,
                                    </span>
                                </span>)
                            </td>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-12">
                                                    <input type="number" id="vatPercent" name="vatPercent"
                                                        v-model="vatPercent" min="0" v-on:input="calculateTotal"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-12">
                                                    <input type="number" id="discount" name="discount"
                                                        class="form-control" min="0" v-model="purchase.discount"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-12">
                                                    <input type="number" id="freight" name="freight"
                                                        class="form-control" min="0" v-model="purchase.freight"
                                                        v-on:input="calculateTotal" />
                                                </div>
                                            </div>
                                        </td>
...
new Vue({
    ...
    methods: {
        ...
        calculateTotal() {
            ...
            this.purchase.discount = isNaN(this.purchase.discount) || this.purchase.discount == '' ? 0 : this
                .purchase.discount;
            this.purchase.freight = isNaN(this.purchase.freight) || this.purchase.freight == '' ? 0 : this
                .purchase.freight;
