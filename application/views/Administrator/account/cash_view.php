    ...
    <div class="row">
        <div class="col-md-4">
            <div class="balance-section">
                ...
                <h1><?php echo $this->session->userdata('Currency_Name');?>
                    <?php echo number_format($transaction_summary->cash_balance, 2);?></h1>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="balance-section">
                ...
                <h1><?php echo $this->session->userdata('Currency_Name');?>
                    <?php echo number_format($bank_balance, 2);?></h1>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="balance-section">
                ...
                <h3>Total Balance</h3>
                <h1><?php echo $this->session->userdata('Currency_Name');?>
                    <?php echo number_format($transaction_summary->cash_balance + $bank_balance, 2);?></h1>
            </div>
        </div>
    </div>
