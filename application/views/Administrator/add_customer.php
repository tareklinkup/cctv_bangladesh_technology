		...
		<div class="row" style="margin-top: 10px;margin-bottom:15px;border-bottom: 1px solid #ccc;padding-bottom:15px;">
			<div class="col-md-5">
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<input type="text" class="form-control" v-model="customer.User_Name" required>
					</div>
				</div>
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<input type="password" class="form-control" v-model="User_Password" required>
					</div>
				</div>
					...
					<div class="col-md-7">
						<input type="password" class="form-control" v-model="customer.r_password" required >
					</div>
				</div>
	...
	new Vue({
		...
		methods: {
			...
			saveCustomer(){
				...
				if(this.User_Password != this.customer.r_password){
