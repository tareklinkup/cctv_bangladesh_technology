...
<div id="cashTransactionReport">
    ...
    <div class="row" style="border-bottom: 1px solid #ccc;padding: 3px 0;">
        <div class="col-md-12">
            <h2 class="center" style="font-weight:bold;">Approved Service List</h2>
        </div>
    </div>
                ...
                <table class="table table-bordered table-condensed">
                    ...
                    <tbody>
                        <tr v-for="service in service_records">
                            ...
                            <td>
                                <a href="#" class="btn btn-primary" v-on:click="fetchRecord(service)">Update</a>
                                <a href="#" class="btn btn-success" v-on:click="fetchRecord(service)">Done</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
...
new Vue({
    ...
    methods: {
        ...
        fetchRecord(service) {
            ...
            axios.post('/get_product_service_record_update', filter).then(res => {
