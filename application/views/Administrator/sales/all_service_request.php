...
<div id="cashTransactionReport">
        ...
        <div class="widget-main">
            <div class="row">
                <div class="col-md-7 col-md-offset-2">
                    <form action="" class="form-horizontal" @submit.prevent="updatePendingService">
                        ...
                        <div class="form-group mb">
                            ...
                            <div class="col-md-8">
                                <textarea class="form-control" rows="3" cols="5" v-model="note"
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-6">
                                <input type="submit" value="Transfer Request" class="button">
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <div class="row" style="border-bottom: 1px solid #ccc;padding: 3px 0;">
        <div class="col-md-12">
            <h2 class="center" style="font-weight:bold;">All Service Request</h2>
        </div>
    </div>
                ...
                <table class="table table-bordered table-condensed">
                    ...
                    <tbody>
                        <tr v-for="service in service_records">
                            ...
                            <td style="text-align:right;">{{service.contact_no}} </td>
                            <td style="text-align:right;"> {{service.request_date}}</td>
                            <td style="text-align:right;"> {{service.note}}</td>
...
new Vue({
    ...
    methods: {
        ...
        serviceRecord() {
            ...
            axios.post('/get_product_service_record', filter).then(res => {
        ...
        updatePendingService() {
            ...
            let filter = {
                ...
                employeeId: this.selectedEmployee != null && this.selectedEmployee.Employee_SlNo != '' ?
                    this.selectedEmployee.Employee_SlNo : null,
                note: this.note,
                service_id: this.service_id,
            }

            axios.post('/update_pending_service', filter).then(res => {
                let r = res.data;
                alert(r.message);
                if (r.success) {
                    location.reload();
        ...
        fetchRecord(service) {
            ...
            axios.post('/get_product_service_record_edit', filter).then(res => {
                ...
                this.service_id = res.data.product_service_id;
