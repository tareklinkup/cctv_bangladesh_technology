                        ...
                        <tr v-for="(transfer, sl) in transfers">
                            ...
                            <td>
                                <button class="btn btn-primary"
                                    v-on:click="approveCashTransfer(transfer)">Approved</button>
                            </td>
                        </tr>
                    </tbody>
                    <tfoot>
    ...
    methods: {
        ...
        getTransfers() {
            ...
            axios.post('/get_cash_receives', this.filter).then(res => {
                this.transfers = res.data.filter((e) => {
                    return e.status == 'p';
                });
            })
        },

        approveCashTransfer(transfer) {

            let approveConf = alert('Are you sure to Approve ?');
