...
<div id="balanceSheet">
    ...
    <form action="" class="form-inline" @submit.prevent="getStatements">
        <div class="row" style="border-bottom: 1px solid #ccc;">
            ...
            <div class="col-md-12">
                <div class="form-group" v-if="userType != 'u' && userType != 'a'">
                    <label class="col-sm-4 control-label no-padding-right">Search Type</label>
                    <div class="col-sm-4">
                        <select class="form-control" v-model="searchType" v-on:change="onChangeSearchType"
                            style="margin-top:5px; height:30px;" style="padding:0px;">
                ...
                <div class="form-group" style="display: none"
                    ...
                    <label class="col-sm-4 control-label no-padding-right">Selected User</label>
                    <div class="col-sm-8">
                        <v-select v-bind:options="users" v-model="selectedUser" label="User_Name"
...
new Vue({
    ...
    methods: {
        ...
        onChangeSearchType() {
            if (this.searchType == 'user' && this.users.length == 0) {
                this.getUsers();
            }
        ...
        async getSales() {
            let filter = {
                ...
                userFullName: this.selectedUser != null ? this.selectedUser.FullName : null,
            }
            await axios.post('/get_sales', filter)
                .then(res => {
        ...
        async getPurchases() {
            ...
            await axios.post('/get_purchases', filter)
                .then(res => {
        ...
        async getEmployeePayments() {
            ...
            let filter = {
                dateFrom: this.filter.dateFrom,
                dateTo: this.filter.dateTo,
                user_id: this.selectedUser != null ? this.selectedUser.User_SlNo : null,
            }

            await axios.post('/get_payments', filter)
                .then(res => {
